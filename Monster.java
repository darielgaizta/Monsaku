...
public class Monster {
	...
	public void printBaseStats() {
		System.out.println("| => Health Point: "+String.valueOf(this.baseStats.getHealthPoint())+"/"+String.valueOf(this.baseStats.getMaxHealthPoint()));
		System.out.println("| => Attack: "+String.valueOf(this.baseStats.getAttack()));
		System.out.println("| => Defense: "+String.valueOf(this.baseStats.getDefense()));
		System.out.println("| => Sp. Attack: "+String.valueOf(this.baseStats.getSpAttack()));
		System.out.println("| => Sp. Defense: "+String.valueOf(this.baseStats.getSpDefense()));
		System.out.println("| => Speed: "+String.valueOf(this.baseStats.getSpeed()));
	}
	...
	public void selectMove() {
		for (int i = 0; i < moves.size(); i++) {
			System.out.println("-["+String.valueOf(i+1)+"] "+moves.get(i).getName());
		}
	}
